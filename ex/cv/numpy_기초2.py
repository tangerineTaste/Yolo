...
def put_text_korean():
    ...
    cv2.rectangle(img, (100,200), (200,300),(0,0,0) )
    cv2.line(img, (100, 200), (150, 150), (0, 0, 0))
    cv2.line(img, (150, 150), (200, 200), (0, 0, 0))
    cv2.rectangle(img, (125,250), (175,300),(0,0,0))
    cv2.line(img, (150, 250), (150, 300), (0, 0, 0))
    cv2.rectangle(img, (135,220), (165,240),(0,0,0))
